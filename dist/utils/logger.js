...
export function createWorkerLogger(workerId) {
    return winston.createLogger({
        level: 'info',
        format: winston.format.combine(winston.format.timestamp(), winston.format.printf(({ timestamp, level, message, url, error }) => {
...
export function createScannerWorkerLogger(workerId) {
    return winston.createLogger({
        level: 'info',
        format: winston.format.combine(winston.format.timestamp(), winston.format.printf(({ timestamp, level, message, domain, error }) => {
